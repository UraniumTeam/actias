...
#include <Actias/Memory/Object.h>
...
namespace Actias::SDK
{
    ...
    public:
        ...
        virtual void CreateInformationHeader(ACBXFileInformationHeader* pHeader) = 0;
        ...
        virtual void CreateSectionHeader(UInt32 sectionID, ACBXSectionHeader* pHeader) = 0;
        ...
        virtual void CopySection(UInt32 sectionID, Byte* pDestination) = 0;
    };
} // namespace Actias::SDK
